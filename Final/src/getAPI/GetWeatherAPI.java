...
public class GetWeatherAPI {
	...
	public static double[] tempResults = new double[6];
	public static double[] PCPResults = new double[6];
	public static double[] humidResults = new double[6];
	public static double[] windResults = new double[6];
	public static int[] popResults = new int[6]; 
	...
	public static void WeatherAPI() throws IOException, ParseException {
        ...
        System.out.println("────────────────────────────────────────────────────────────────────────────────────────");
        System.out.println(" 시각   |  온도(℃) |    하늘상태    |  풍속(m/s)  |   습도   |  강수형태(확률)  |  강수량");
        System.out.println("────────────────────────────────────────────────────────────────────────────────────────");
        ...
        for (String timeKey : weatherTime.keySet()) {
            ...
            if(currentPcpStatus.equals("강수없음"))
            	PCPResults[idx] = 0.0;
            else
            	PCPResults[idx] = ExtractNumber.extractNumber(currentPcpStatus);
            
            popResults[idx] = (int)ExtractNumber.extractNumber(currentPopStatus);
            idx++;
